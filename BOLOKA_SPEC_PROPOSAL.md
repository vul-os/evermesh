# Boloka Protocol — Specification Proposal (Draft 0.1)

**Status:** Pre-RFC draft for discussion
**Editor:** (you)
**Intended home:** boloka.org
...
Boloka is a protocol for publishing, distributing, and discussing video without any
...
- "Boloka-compliant" is a certifiable trademark claim (reference-gateway obligations,
...
single-log limitation). Boloka's contribution is the combination, plus the two
