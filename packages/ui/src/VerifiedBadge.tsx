...
const STATE_COPY: Record<VerifiedState, { label: string; icon: string; ring: string }> = {
  verifying: {
    label: "Verifying…",
    icon: "◐",
    ring: "border-slate-300 bg-slate-50 text-slate-700 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200",
  },
  verified: {
    label: "Verified",
    icon: "✓",
    ring: "border-accent-600 bg-accent-50 text-accent-900 dark:border-accent-400 dark:bg-accent-950 dark:text-accent-100",
  },
  failed: {
    label: "Verification failed",
    icon: "✕",
    ring: "border-red-600 bg-red-50 text-red-900 dark:border-red-400 dark:bg-red-950 dark:text-red-100",
  },
};
