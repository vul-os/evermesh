...
{{GATEWAY_NAME}} runs on the Vidmesh protocol. Plainly, that means:

- Video and metadata on Vidmesh live as signed records and
...
Your Vidmesh identity is a cryptographic keypair, not a row in our
...
proving your history on any other Vidmesh gateway or with your own
tools.
...
and cannot revoke your Vidmesh identity, delete your content from the
