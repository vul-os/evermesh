    ...
    >
      ...
      <div className="mt-3 flex gap-2.5">
        ...
        <div className="min-w-0">
          ...
          {/* Channel + recency on one line, the same "channel · time" scan
              pattern most media apps use, instead of two stacked lines —
              a card's metadata block reading as two disconnected labels
              was part of why the grid felt sparse rather than dense. */}
