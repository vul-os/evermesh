//! Boloka node app (Tauri 2 scaffold, Phase 8).
//!
...
//! boloka-node` must succeed on a bare toolchain, without the `tauri` CLI
//! installed.
//!
...
fn main() {
    tauri::Builder::default()
        ...
        .expect("error while running boloka-node scaffold");
}
