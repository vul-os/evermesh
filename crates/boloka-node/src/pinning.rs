//! Pin store: the real v1 design surface for what a Boloka node persists.
//!
...
//! - Everything here is content-addressed against `boloka-kernel` ids
...
use boloka_kernel::{BlobId, RecordId};
