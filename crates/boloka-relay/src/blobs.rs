...
/// The single call site into `boloka_kernel::ChunkTree` (spec 001 §8).
...
fn compute_chunk_proof(
    ...
    use boloka_kernel::blob::CHUNK_SIZE;
    use boloka_kernel::ChunkTree;
...
mod tests {
    ...
    async fn put_then_read_back_matches_and_hash_is_derived_not_trusted() {
        ...
        let payload = b"hello boloka blob".to_vec();
