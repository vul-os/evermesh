...
//! corpus — through boloka's §22 path, asserting **byte-exact** agreement on
...
//! second from-scratch implementation. Passing them means boloka's §22 path
...
//!
//! Run with: `cargo test -p boloka-kernel --features dmtap-pub`

#![cfg(feature = "dmtap-pub")]

use serde_json::Value as J;
use boloka_kernel::dmtap_pub::*;
    ...
    for v in vectors {
        ...
        match op {
            ...
            "pub_manifest_root" => {
                ...
                // ...and a full PubManifest built the boloka way agrees and self-verifies.
