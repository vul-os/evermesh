# Vidmesh Protocol — Specification Proposal (Draft 0.1)

**Status:** Pre-RFC draft for discussion
**Editor:** (you)
**Intended home:** vidmesh.org
...
Vidmesh is a protocol for publishing, distributing, and discussing video without any
...
- "Vidmesh-compliant" is a certifiable trademark claim (reference-gateway obligations,
...
single-log limitation). Vidmesh's contribution is the combination, plus the two
